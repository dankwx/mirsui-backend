...
console.log('  ids do Spotify resolvidos    :', resultado.spotifyResolvidos)
console.log('  sem resultado no Spotify     :', resultado.spotifyNaoAchados)
console.log('  falhas transitorias (429/rede):', resultado.spotifyFalhasTransitorias)
