...
console.log('  promovidas a acervo (salvas) :', resultado.promovidasAoAcervo)
console.log('  trocaram de banda            :', resultado.reclassificadas)
console.log('    - lotes da cadencia        :', resultado.cadenciaLotes)
console.log('    - faixas examinadas        :', resultado.cadenciaExaminadas)
console.log('  bandas                       :', JSON.stringify(resultado.bandas))
console.log('  orcamento da etapa 3         :', resultado.orcamentoMedicao)
console.log('  fila vencida                 :', resultado.filaVencida)
console.log('  medidas uma a uma            :', resultado.medidasIndividuais)
console.log('  adiadas (orcamento acabou)   :', resultado.adiadas)
...
console.log('  descoberta — radio (ADR 001)')
console.log('    - sementes processadas     :', resultado.descobertaSementes)
...
console.log('  descoberta — album (ADR 002)')
console.log('    - artistas na fronteira    :', resultado.descobertaFronteira)
console.log('    - faixas colhidas          :', resultado.descobertaColhidasPorAlbum)
console.log('    - novas (o resto ja tinha) :', resultado.descobertaNovasPorAlbum)
console.log('    - requisicoes gastas       :', resultado.descobertaRequisicoesDeAlbum)
